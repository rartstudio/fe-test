<template>
  <div class="flex flex-col justify-start items-center pt-32 bg-slate-100 min-h-screen">
    <h1 class="text-6xl text-Brandblue mb-8" id="header-title">Offices</h1>
    ...
    <button id="button-new-location" v-else @click="openForm" class="w-[317px] h-[56px] bg-Brandblue flex justify-between items-center text-white py-[16px] px-[24px] rounded-lg cursor-pointer hover:bg-Brandblue/90 shadow-xl">
